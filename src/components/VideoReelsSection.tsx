...
const REEL_VIDEOS = [
  {
    ...
    title: "Natural Dishwashing Liquid",
    productId: 2,
  },
  {
    src: "/videos/cleaning-2.mp4",
    title: "Eco-Friendly Floor Cleaner",
    productId: 5,
  },
  {
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <p className="text-white/80 text-xs">
                            ₹{product.price}{" "}
                            <span className="line-through text-white/50">₹{product.originalPrice}</span>
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              <div className="max-w-lg mx-auto flex items-center gap-3">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-white/80 text-sm">
                    ₹{activeProduct.price}{" "}
                    <span className="line-through text-white/50">₹{activeProduct.originalPrice}</span>
                  </p>
                </div>
                <button
                  onClick={() => setShowProductInfo(!showProductInfo)}
                  className="bg-white text-foreground text-xs font-bold px-4 py-2 rounded-lg hover:bg-white/90 transition-colors flex items-center gap-1"
                >
                  ...
                  <div className="flex gap-3 mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-foreground">
                        ₹{activeProduct.price}{" "}
                        <span className="text-sm line-through text-muted-foreground">₹{activeProduct.originalPrice}</span>
                      </p>
                    </div>
                  </div>
